...
[![Maven Central](https://img.shields.io/badge/maven--central-0.2.0-86dbce?style=for-the-badge&logoColor=D9E0EE&labelColor=1E202B)](https://central.sonatype.com/search?q=dev.hivens.libsound)
...
**0.2.0, and deliberately a 0.** Published so something can depend on it and
...
```kotlin
implementation("dev.hivens:libsound-core:0.2.0")     // contracts, no backend
implementation("dev.hivens:libsound-audio:0.2.0")    // playback, capture, the mixer
implementation("dev.hivens:libsound-session:0.2.0")  // media sessions
implementation("dev.hivens:libsound-dsp:0.2.0")      // gain, filter, limiter, tap
```
